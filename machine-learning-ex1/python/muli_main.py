...
for i in range(len(functions)):
	if i == 0:
		thread = Thread(target=functions[i], args=(X_multi, y, p, ilambda))
		threads.append(thread) 
	else:
		thread = Thread(target=functions[i], args=(X_multi, y, p, batch_num_iters, ilambda))
		threads.append(thread) 
